  ...
  return (
    <>
      ...
      <details id="verwaltung" open className="scroll-mt-24 rounded-[28px] border border-[var(--border)] bg-[var(--card)]/95 p-5 shadow-2xl shadow-black/20 sm:p-7">
        ...
        <details className="mt-6 rounded-[24px] border border-[var(--border)] bg-[var(--card-2)] p-5" open>
          <summary className="cursor-pointer list-none text-lg font-semibold text-white">
            Medikamente verwalten
          </summary>
          <p className="mt-2 text-sm text-[var(--muted)]">
            Aktive, inaktive, archivierte, Bedarf und PAN übersichtlich ausklappen.
          </p>
